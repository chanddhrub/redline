...
Upload a contract, lease, freelance agreement or terms of service. Get back a
...
clause, a question box answered only from the document, an editable list of
your own red lines that drives the analysis, and a library of past documents.
...
document between users. None make the analysis more trustworthy. OCR actively
undermines it — a citation is worthless when the text it points at was
misread.
...
- State only what the document says. Where the text does not support a claim,
  the product does not make it. This applies to the summary, the severity
  ranking, the counter-offers and the question box alike.
- Ask before adding a dependency.

## Open decisions — ask, do not pick

Undecided as of 2026-08-28. If a task needs one resolved, stop and ask rather
than choosing a default and building on it.
